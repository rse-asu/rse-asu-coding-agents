...
- [Scientific computing in the age of agentic AI: an exploratory field report](https://doi.org/10.64898/2026.07.29.741496) — Jeremy Li and colleagues (2026; exploratory preprint with OpenAI-affiliated authors). Eight terrific, deep, contributor-written case studies, mainly in the life sciences. Describes engineering assistance alongside persistent scientific validation and maintenance challenges. Not a lot of empirical conclusion but the use cases are worth the price of admission.
